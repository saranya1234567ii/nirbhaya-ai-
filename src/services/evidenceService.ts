...
export const DEFAULT_EVIDENCE: EvidenceItem[] = [
  {
    ...
    location: 'Anna Salai (Lat: 13.0827, Lng: 80.2707)',
    duration: '00:18',
    ...
    chainOfCustody: [
      ...
      { stage: 'Stored in Encrypted Vault', timestamp: '17:42:15 UTC', verified: true },
    ]
  },
  {
    id: 'ev_snap_03',
    ...
    location: 'Mount Road (Lat: 13.0827, Lng: 80.2707)',
    duration: 'N/A (Still Image)',
    fileType: 'JPEG (EXIF Encrypted)',
    size: '2.1 MB',
    isLocked: true,
